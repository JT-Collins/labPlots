...
An example of the labplots can be found at `system.file("Cookbook.html", package = "labPlots")` once installed. You can open the file from R by running `browseURL(system.file("Cookbook.html", package = "labPlots"))`
